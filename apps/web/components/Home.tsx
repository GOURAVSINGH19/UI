        ...
        <section className='w-full h-1/2 flex items-center mt-[4vw] flex-col mb-10'>
            ...
            <div className='btn_container w-full leading-[130%] flex justify-center items-center gap-5 mt-8'>
                <Link href="/docs/index">
                    <button className='px-6  py-2 text-sm bg-[#fff] rounded-full flex items-start gap-2 w-max shadow-[var(--shadow-m)] cursor-pointer text-black'>
                        Get Started
                    </button>
                </Link>
