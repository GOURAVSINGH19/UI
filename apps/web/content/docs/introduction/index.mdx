...
<Callout type="info" title="Getting Started">
  Browse the components in the sidebar to see what's available. Each component includes usage examples, API documentation, and source code you can copy directly.
</Callout>
