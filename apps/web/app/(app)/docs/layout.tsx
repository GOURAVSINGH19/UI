...
export default function DocsLayout({ children }: DocsLayoutProps) {
  return (
    <div className="border-b pt-10 md:pt-8">
      <div className="flex-1 items-start bg-[#FAFAFA] px-2 dark:bg-[#171517] sm:px-4 md:grid md:grid-cols-[150px_minmax(0,1fr)] md:gap-6 lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-1 pt-4">
