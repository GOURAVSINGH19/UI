  ...
  return (
    <div className="border-b pt-10 md:pt-7">
      <div className="flex-1  items-start bg-[#FAFAFA] px-2 dark:bg-[var(--bg)] sm:px-4 md:grid md:grid-cols-[150px_minmax(0,1fr)] md:gap-6 lg:grid-cols-[200px_minmax(0,1fr)] lg:gap-1 pt-4">
        <aside className={cn("fixed top-14 z-30 -ml-2 hidden h-[calc(100vh-9rem)] w-full shrink-0 md:sticky md:block","bg-gradient-to-t from-white/0 via-white/6 to-white/0 backdrop-blur-xs ring-[.4px] ring-white/50  rounded-sm")}>
